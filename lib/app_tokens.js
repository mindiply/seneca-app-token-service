            ...
            var p = new Promise(function (resolve, reject) {
                try {
                    (function () {
                        ...
                        resolve(Promise.all([redisClient.lpush.apply(redisClient, [tokenKey, userId].concat(_toConsumableArray(scopes))), redisClient.expire(tokenKey, expirationSeconds)]).then(function (results) {
                            return tokenData;
                        }));
                    })();
                } catch (err) {
